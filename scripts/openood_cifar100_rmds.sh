...
for iter in 0 1 2; do
    CUDA_VISIBLE_DEVICES=$cuda_device_id python train_rmds_openood.py \
        ...
        --model-iter $iter \
        --log_path cifar100_openood_exps/mds_rmds/logs/${featprefix}s${iter}.log \
        --output_path cifar100_openood_exps/mds_rmds/results \
    ...
    CUDA_VISIBLE_DEVICES=$cuda_device_id python train_rmds_openood.py \
        ...
        --data-root cifar100_feats/ \
        --model-iter $iter \
        --log_path cifar100_openood_exps/mds_rmds/logs/${featprefix}s${iter}_autowhiten.log \
        --output_path cifar100_openood_exps/mds_rmds/results \
