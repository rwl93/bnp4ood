...
CUDA_VISIBLE_DEVICES=$cuda_device_id python train_msp_openood.py \
    --features $feats \
    --log_path openood_exps/msp/logs/${featprefix}vit768.log \
    --output_path openood_exps/msp/results \
    --prefix ${featprefix}vit768_

CUDA_VISIBLE_DEVICES=$cuda_device_id python train_msp_openood.py \
    --autowhiten \
    --features $feats \
    --log_path openood_exps/msp/logs/${featprefix}autowhiten.log \
    --output_path openood_exps/msp/results \
    --prefix ${featprefix}autowhiten_

CUDA_VISIBLE_DEVICES=$cuda_device_id python train_msp_openood.py \
    --usepca --pca_dim 765 \
    --features $feats \
    --log_path openood_exps/msp/logs/${featprefix}pca765.log \
    --output_path openood_exps/msp/results \
    --prefix ${featprefix}pca765_
