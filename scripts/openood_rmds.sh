...
CUDA_VISIBLE_DEVICES=$cuda_device_id python train_rmds_openood.py \
    --features $feats \
    --log_path openood_exps/mds_rmds/logs/${featprefix}vit768.log \
...
CUDA_VISIBLE_DEVICES=$cuda_device_id python train_rmds_openood.py \
    --autowhiten \
    --features $feats \
    --log_path openood_exps/mds_rmds/logs/${featprefix}autowhiten.log \
    --output_path openood_exps/mds_rmds/results \
...
CUDA_VISIBLE_DEVICES=$cuda_device_id python train_rmds_openood.py \
    --usepca --pca_dim 765 \
    --features $feats \
    --log_path openood_exps/mds_rmds/logs/${featprefix}pca765.log \
    --output_path openood_exps/mds_rmds/results \
