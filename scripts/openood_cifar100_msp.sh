...
for iter in 0 1 2; do
    CUDA_VISIBLE_DEVICES=$cuda_device_id python train_msp_openood.py \
        ...
        --model-iter $iter \
        --log_path cifar100_openood_exps/msp/logs/${featprefix}s${iter}.log \
        --output_path cifar100_openood_exps/msp/results \
    ...
    CUDA_VISIBLE_DEVICES=$cuda_device_id python train_msp_openood.py \
        ...
        --data-root cifar100_feats/ \
        --model-iter $iter \
        --log_path cifar100_openood_exps/msp/logs/${featprefix}s${iter}_autowhiten.log \
        --output_path cifar100_openood_exps/msp/results \
