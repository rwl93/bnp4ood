...
for ((i=1; i<=9; i++)); do
    dim=$((2**i))
    log_path="openood_exps/full/logs/pca${dim}.log"
    output_filename="openood_exps/full/results/pca${dim}.result"
    ...
    log_path="openood_exps/full/logs/autowhiten${dim}.log"
    output_filename="openood_exps/full/results/autowhiten${dim}.result"
